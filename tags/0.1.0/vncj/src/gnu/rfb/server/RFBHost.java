...
public class RFBHost implements Runnable {
    ...
    private ArrayList<RFBSocket> servers = new ArrayList<RFBSocket>();
    ...
    public RFBHost( int display, String displayName, Class<?> rfbServerClass, RFBAuthenticator authenticator ) throws NoSuchMethodException {
        ...
        new Thread( this ,displayName+"_thread").start();        
    }
    public RFBHost( int display, String displayName, Class<?> rfbServerClass, RFBAuthenticator authenticator,ThreadDispatcher dispatcher ) throws NoSuchMethodException {
        // Get constructor
        constructor = rfbServerClass.getDeclaredConstructor( new Class[] { int.class, String.class } );
        ...
        dispatcher.startThread(new Thread( this ,displayName+"_thread"));
    }   
    ...
    public void run() {
        ...
        try {
            ...
            while( isRunning ) {
                ...
                RFBSocket r = new RFBSocket( serverSocket.accept(), getSharedServer(), this, authenticator );
                servers.add(r);
